# The Old Guard Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/old-guard/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest OG into src-en/ directory
